...
class VoskFlutterPlugin {
  ...
  Future<SpeechService> initSpeechService(final Recognizer recognizer) async {
    ...
    final speechService = SpeechService(_channel);
  ...
  Future<void> _methodCallHandler(final MethodCall call) async {
    switch (call.method) {
      ...
      case 'speakerModel.error':
        ...
        return;
      case 'speechService.onResult':
      case 'speechService.onFinalResult':
        _activeSpeechService?.emitResult(call.arguments.toString());
        return;
      case 'speechService.onPartial':
        _activeSpeechService?.emitPartial(call.arguments.toString());
        return;
      default:
